 ...
 * <purpose>manage all Logo entity actions process in this controller, for custom process create a new Logo and update an existing Logo</purpose>
 */
...
class LogoAdminController extends CRUDController {
