 ...
 * <purpose>custom the ContentDetail entity form for Sonata\AdminBundle\Admin\Admin</purpose>
 */
...
class ContentDetailAdmin extends Admin {
    ...
    protected function configureFormFields(FormMapper $formMapper) {
        $formMapper
                ...
                ->add('categorycontent', 'entity', array('label' => 'Content Titile',
                    'required' => true,
                    'expanded' => false,
                    'class' => 'Yorku\JuturnaBundle\Entity\Content',
                    'property' => 'title',
                    'multiple' => false
                ))
                ->add('position')
