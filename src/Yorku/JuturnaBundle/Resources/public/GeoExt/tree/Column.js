...
Ext.define('GeoExt.tree.Column', {
    ...
    //         if(record.get('radioGroup'))
     //        {
	//	alert(buf[0]);
		//alert(buf[1]);
		//alert(buf[2]);
//buf[0].replace(/class="([^-]+)-tree-icon-parent([^"]+)?"/, 'class="gx-tree-radio $1-tree-icon-parent$2"');

	//	alert(buf[0]);


               //  buf.push('<div class="gx-tree-radio" id="tree-record-radio_'+record.id+'"></div>');
       //      }
