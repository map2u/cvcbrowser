...
namespace Ibrows\Map2uBundle\Entity\Newsletter;

use Ibrows\Bundle\NewsletterBundle\Entity\Subscriber as BaseSubscriber;
 ...
 *      uniqueConstraints={@ORM\UniqueConstraint(name="unique_idx_subscriber", columns={"hash"})}
 * )
 */
