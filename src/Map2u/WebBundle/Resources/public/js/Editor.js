...
OpenLayers.Editor = OpenLayers.Class({
     ...
     */
    editorControls: ['SaveFeature','CleanFeature', 'DeleteFeature', 'DeleteAllFeatures', 'Dialog', 'DrawHole', 'DrawRegular',
...
//					labelYOffset: 0,
        ...
        var selectionContext = {
            ...
            controls: [
                ...
                'OpenLayers.Editor.Control.SaveFeature',
        ...
        for (var i = 0, len = editor.activeControls.length; i < len; i++) {
            ...
            switch (control) {
                ...
                case 'ModifyFeature':
                    ...
                    break;
//                case 'SaveFeature':
//                    controls.push(new OpenLayers.Editor.Control.SaveFeature(editor.editLayer,
//                            OpenLayers.Util.extend(
//                                    {title: OpenLayers.i18n('oleSaveFeature')},
//                                    editor.options.SaveFeature)
//                    ));
//                    break;
