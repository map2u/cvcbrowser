...
//    var path;
    ...
    $(window).resize(function () { /* do something */
        ...
        $('#leafmap').height($(window).height() - $(".juturna-page-header").height() - $(".juturna-main-menu").height());
//        $('#leafmap').css('height',$('#leafmap').height());
//        $('#leafmap').css('width',$('#leafmap').width());
        $('#map-ui').height($(window).height() - $(".juturna-page-header").height() - $(".juturna-main-menu").height());
