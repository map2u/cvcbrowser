...
OpenLayers.Editor.Control.LayerSettings =  OpenLayers.Class(OpenLayers.Control, {
    ...
    showLayerSettings: function(layerName) {
     ...
     /*       importInputRadio = document.createElement('input');
            importInputRadio.type = 'radiobutton';
            importInputRadio.name = 'import'+this.currentLayer.name;
            content.appendChild(importInputRadio);
*/
