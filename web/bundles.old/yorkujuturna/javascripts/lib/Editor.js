...
//					labelYOffset: 0,
        ...
        this.editLayer.selectionContext=selectionContext;
        this.editLayer.events.register('beforefeatureadded', this.editLayer.selectionContext, this.featureAdded);
        this.editLayer.events.register('featureadded', this.editLayer.selectionContext, this.featureAdded);
        this.editLayer.events.register('featureselected', this.editLayer.selectionContext, this.selectionChanged);
        this.editLayer.events.register('featureunselected', this.editLayer.selectionContext, this.selectionChanged);
        ...
        for (var i = 0, il = this.sourceLayers.length; i < il; i++) {
            ...
            this.sourceLayers[i].selectionContext=selectionContext;
            this.sourceLayers[i].events.register('beforefeatureadded', this.sourceLayers[i].selectionContext, this.featureAdded);
            this.sourceLayers[i].events.register('featureadded', this.sourceLayers[i].selectionContext, this.featureAdded);
            this.sourceLayers[i].events.register('featureselected', this.sourceLayers[i].selectionContext, this.selectionChanged);
            this.sourceLayers[i].events.register('featureunselected', this.sourceLayers[i].selectionContext, this.selectionChanged);
        ...
        this.editLayer.id=this.editLayer.name;
    ...
    selectionChanged: function (evt) {
        ...
        OpenLayers.Editor.prototype.featureSelectionChanged.call(this,evt);
    },
            ...
            switch (control) {
                ...
                case 'DragFeature':
                    ...
                    controls.push(new OpenLayers.Editor.Control.DragFeature(editor.editLayer,
                            OpenLayers.Util.extend({ hover: true}, editor.options.DragFeature)
                    ));
                    break;
    ...
    changeEditorLayer: function (options) {
    		if(options.editLayer)
    		{
    			if(this.editLayer)
    			{
    	                this.editLayer.events.unregister('beforefeatureadded', this.editLayer.selectionContext, this.featureAdded);
    	                this.editLayer.events.unregister('featureadded', this.editLayer.selectionContext, this.featureAdded);
    	                this.editLayer.events.unregister('featureselected', this.editLayer.selectionContext, this.selectionChanged);
    	                this.editLayer.events.unregister('featureunselected', this.editLayer.selectionContext, this.selectionChanged);
    		...
    		if(options.sourceLayers)
    		{
                for (var i = 0, il = this.sourceLayers.length; i < il; i++) {
                    ...
                    this.sourceLayers[i].events.unregister('beforefeatureadded', this.sourceLayers[i].selectionContext, this.featureAdded);
                    this.sourceLayers[i].events.unregister('featureadded', this.sourceLayers[i].selectionContext, this.featureAdded);
                    this.sourceLayers[i].events.unregister('featureselected', this.sourceLayers[i].selectionContext, this.selectionChanged);
                    this.sourceLayers[i].events.unregister('featureunselected', this.sourceLayers[i].selectionContext, this.selectionChanged);
                }
            ...
            for (var i = 0, il = this.sourceLayers.length; i < il; i++) {
                ...
                var layers=this.map.getLayersByName(this.sourceLayers[i].name);
            ...
            this.map.editor = this;
            this.editLayer.id=this.editLayer.name;
            var layers=this.map.getLayersByName(this.editLayer.name);
            ...
            this.map.LayerSettings=new OpenLayers.Editor.Control.LayerSettings(this);
            this.map.addControl(this.map.LayerSettings);

            if (this.undoRedoActive) {
                this.map.addControl(new OpenLayers.Editor.Control.UndoRedo(this.editLayer));
            }
            this.addEditorControls();
            this.editorPanel.redraw();
